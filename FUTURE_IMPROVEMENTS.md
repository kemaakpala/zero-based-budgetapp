...
- [ ] **Dedicated Setup / Settings Page**: Create an onboarding/setup wizard page where users can configure their Starting Salary and initialize their budget groups and items before entering the main dashboard.
